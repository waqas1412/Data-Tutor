...
const LessonContent: React.FC<LessonContentProps> = ({ lesson }) => {
  return (
    <div className="p-6 overflow-auto">
      <div className="prose prose-sm max-w-none whitespace-normal break-words dark:prose-invert dark:text-gray-300 
        prose-headings:text-primaryColor dark:prose-headings:text-primaryColor 
        prose-a:text-primaryColor dark:prose-a:text-primaryColor prose-a:break-all prose-a:overflow-wrap-anywhere
